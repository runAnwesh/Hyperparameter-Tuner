...
In this implementation, the *RandomForestRegressor()* function is used for building a regression model using the **Random Forest** algorithm.
...
parameter_criterion = st.sidebar.select_slider('Performance measure (criterion)', options=['poisson', 'friedman_mse', 'squared_error', 'absolute_error'])
